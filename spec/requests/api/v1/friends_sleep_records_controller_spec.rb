  ...
  describe 'GET #index' do
    context 'when sleep records exist' do
      before do
        ...
        create(:sleep_record, user: friend2, clock_in_time: 1.day.ago, clock_out_time: nil)
        create(:sleep_record, user: friend1, clock_in_time: nil, clock_out_time: 6.hours.ago)
